...
const navLinks = [
  ...
  { label: "Para agências", href: "/instagram-dm-automation-agencies", key: "agencies" },
  { label: "Recursos", href: "/#recursos", key: "features" },
  { label: "Segurança", href: "/#seguranca", key: "security" },
];

export default function PublicSiteHeader({ active }: PublicSiteHeaderProps) {
  return (
    <header className="sticky top-0 z-40 border-b border-[#27433a] bg-[#112620]/95">
