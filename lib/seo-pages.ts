...
export const manychatAlternativePage: SeoPageConfig = {
  ...
  description:
    "ReplyFlow is for teams that do not need a broad chatbot builder. It turns keyword comments into Meta-compliant private replies, tracked links, campaign analytics, and client reports.",
  ...
  sections: [
    {
      ...
      body: "Broad automation suites can be powerful, but they also add flow-builder weight. ReplyFlow keeps the campaign path tight: keyword, post, reply, link, result.",
    },
    {
      title: "Agency proof",
  ...
  comparisonTitle: "ReplyFlow vs broad chatbot builders",
  comparisons: [
    {
      label: "Setup",
  ...
  faqs: [
    {
      title: "Is ReplyFlow a full Manychat replacement?",
      body: "No. ReplyFlow is intentionally focused on Instagram comment-to-DM campaigns. If you need a complete chatbot suite, use a broad platform. If you need fast campaign loops, ReplyFlow is built for that.",
    },
    {
      title: "Does it support agencies?",
      body: "Yes. It supports multiple Instagram accounts, workspace members, account filters, analytics, and shareable reports, with capacity defined by plan.",
    },
  ],
};
...
export const agenciesSeoPage: SeoPageConfig = {
  ...
  description:
    "ReplyFlow gives agencies multi-account workspaces, client-ready reports, tracked links, and a focused comment-to-DM workflow for repeatable Instagram campaigns.",
...
export const commentLinkSeoPage: SeoPageConfig = {
  ...
  faqs: [
    ...
    {
      title: "Does ReplyFlow send a normal Instagram DM?",
