    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,340px)_1fr]">
      ...
      <div className="space-y-6">
        ...
        <Summary title="E o comentário contiver">
          ...
          {campaign.dmTriggerEnabled && (
            <p className="text-xs text-muted">
              Também responde quando alguém enviar por DM{" "}
        ...
        {campaign.requireFollow && (
          <Summary title="A pessoa precisa seguir o perfil primeiro">
            <FieldBox>
        ...
        <Summary title="Depois, a pessoa receberá uma DM">
          ...
          <Summary title="Depois, uma mensagem de acompanhamento">
            ...
            <p className="text-xs text-muted">
              {campaign.followUpDelayMinutes && campaign.followUpDelayMinutes > 0
                ? `Enviada ${campaign.followUpDelayMinutes} min após o link.`
